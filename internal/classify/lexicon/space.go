...
// investigation, not a spacecraft. `black hole` is present at a secondary
// weight — science.go carries the primary weight for it, since most
// black-hole coverage is a physics or astronomy finding rather than a
// mission story.
