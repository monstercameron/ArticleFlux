...
func (x *ChangeUsernameRequest) GetCurrentPassword() string {
	if x != nil {
		return x.CurrentPassword
	}
	return ""
...
const file_articleflux_v1_auth_proto_rawDesc = "" +
	...
	"\x0fsudo_expires_at\x18\x01 \x01(\tR\rsudoExpiresAt\"e\n" +
