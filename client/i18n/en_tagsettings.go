...
// rail draws). A translator who blurs the two hands the reader a panel that
...
func init() {
	text(DefaultLocale, "tagSettings", map[string]string{
		...
		"glyphDefault":   "Default mark",

		"feedsGroup": "Feeds",
		"feedsEmpty": "No feeds carry this tag. It will disappear from the rail on its own.",
